    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-4 sm:p-5 shadow-sm space-y-4">
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Buscar por nome, SKU, código de barras ou tamanho..."
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl pl-10 pr-24 py-2.5 text-xs sm:text-sm focus:outline-none focus:border-rose-500 transition text-slate-900 dark:text-white"
            />
            <div className="absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-1">
              ...
              <button
                ...
                className="px-2.5 py-1.5 bg-rose-500 hover:bg-rose-600 text-white rounded-xl text-xs font-bold flex items-center gap-1 shadow-sm transition active:scale-95"
                    ...
                    <div>
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          {prod.sku && (
                            <span className="text-[10px] font-black bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 px-2 py-0.5 rounded-md border border-slate-200 dark:border-slate-700 notranslate" translate="no">
                              Cód: {prod.sku}
                            </span>
                          )}
                          {prod.barcode && (
                            <span className="text-[10px] font-mono font-bold bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 px-1.5 py-0.5 rounded-md border border-rose-200 dark:border-rose-900/50 notranslate" translate="no" title={`Código de Barras: ${prod.barcode}`}>
                              EAN
                            </span>
                          )}
                        </div>
                        ...
                        <div className="flex items-center gap-3 notranslate" translate="no">
                          ...
                          <div className="notranslate" translate="no">
                            <div className="flex items-center gap-2 notranslate" translate="no">
                              ...
                              {prod.barcode && (
                                <span className="text-[10px] font-mono font-bold bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 px-1.5 py-0.5 rounded border border-rose-200 dark:border-rose-900/50 shrink-0 notranslate" translate="no" title={`Código de Barras: ${prod.barcode}`}>
                                  EAN: {prod.barcode}
                                </span>
                              )}
                            </div>
      ...
      {isBarcodeScanOpen && (
        <BarcodeScannerModal
          ...
          products={products}
          title="Escanear Código de Barras no Estoque"
          description="Aponte a câmera para a etiqueta do produto para localizá-lo instantaneamente na lista"
        />
      )}
