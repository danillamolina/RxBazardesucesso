        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center space-x-3 w-full md:w-auto justify-between md:justify-start">
            <div className="flex items-center space-x-2.5">
              <div className="bg-gradient-to-tr from-rose-500 via-purple-500 to-amber-400 p-2 rounded-xl shadow-lg shadow-rose-500/20">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 hidden sm:block">Controle de Estoque, Margens & Lucro em Tempo Real</p>
              </div>
            </div>
            ...
            <button
              ...
              className="md:hidden flex items-center text-xs bg-slate-800 hover:bg-slate-700 text-slate-300 px-2.5 py-1.5 rounded-lg border border-slate-700 transition"
            >
              <Calendar className="h-3.5 w-3.5 text-rose-400 mr-1.5" />
          ...
          <div className="flex items-center space-x-2 w-full md:w-auto justify-end overflow-x-auto pb-1 md:pb-0">
            ...
            <button
              onClick={() => setShowEditionModal(true)}
              className="hidden md:flex items-center text-xs bg-slate-800 hover:bg-slate-700 text-slate-200 px-3 py-2 rounded-lg border border-slate-700 transition"
            ...
            <button
              ...
              className="flex items-center bg-emerald-600 hover:bg-emerald-500 text-white font-medium text-xs sm:text-sm px-3 sm:px-4 py-2 rounded-lg shadow-sm transition active:scale-95"
            >
            ...
            <button
              ...
              className="flex items-center bg-slate-800 hover:bg-slate-700 text-slate-200 font-medium text-xs sm:text-sm px-3 py-2 rounded-lg border border-slate-700 transition"
            >
            ...
            <button
              ...
              className="flex items-center bg-slate-800 hover:bg-slate-700 text-rose-300 hover:text-white font-medium text-xs sm:text-sm px-3 py-2 rounded-lg border border-slate-700 transition"
              title="Configurações, Backup & Relatórios PDF"
            >
              <Settings className="h-4 w-4 mr-1 text-rose-400" />
